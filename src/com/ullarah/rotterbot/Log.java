...
class Log {
     ...
     */
    private static boolean ERROR = level <= LEVEL_ERROR;
    /**
     * True when the WARN level will be logged.
     */
    private static boolean WARN = level <= LEVEL_WARN;
    /**
     * True when the INFO level will be logged.
     */
    private static boolean INFO = level <= LEVEL_INFO;
    /**
     ...
     */
    private static boolean DEBUG = level <= LEVEL_DEBUG;
    /**
     ...
     */
    private static boolean TRACE = level <= LEVEL_TRACE;
